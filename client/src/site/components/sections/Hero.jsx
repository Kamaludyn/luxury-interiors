...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="w-fit mx-auto bg-primary-500 text-surface-600 px-6 py-2 text-xl md:text-3xl lg:text-4xl font-semibold dark:text-accent-800 rounded-4xl leading-tight animate-fadeIn">
          {heroImages[currentIndex].title}
        </h1>
        <p className="bg-surface-500 pt-4 pb-2 px-4 -mt-2 text-base md:text-xl text-primaary-500 max-w-2xl mx-auto rounded-4xl leading-relaxed z-50">
